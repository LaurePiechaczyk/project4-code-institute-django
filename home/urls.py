...
urlpatterns = [
    ...
    path(
        'go_to_category/<category_id>/feminine', 
        views.categorie_feminine, 
        name='categorie_feminine'
        ),
    path(
        'go_to_category/<category_id>/masculine', 
        views.categorie_masculine, 
        name='categorie_masculine'
        ),
    path(
        'go_to_category/<category_id>/neutral', 
        views.categorie_neutral, 
        name='categorie_neutral'
        ),
